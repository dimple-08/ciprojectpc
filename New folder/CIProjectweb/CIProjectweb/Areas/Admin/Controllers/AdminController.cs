...
namespace CIProjectweb.Areas.Admin.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public IActionResult Index(long id)
        {
            ...
            List<City> cities = _objIAdmin.cities();
        ...
        {
            bool success = _objIAdmin.saveuser(userView);
            if (!success)
            {
        ...
        public IActionResult Theme()
        {
            ...
            ViewBag.nav = HttpContext.Session.GetInt32("Nav");
            List<MissionTheme> missionThemes = _objIAdmin.allthemes();
        ...
        {
            bool success = _objIAdmin.deletetheme(themeId); 
            return Json(new { success = success });
        ...
        public IActionResult Mission(MissionView missionView, string[] selectedValues, string[] dataUrls, string[] docFiles, string[] docName, string videoUrls)
        {
            ...
            bool success = _objIAdmin.savemission(missionView, selectedValues, dataUrls, docFiles, docName, videoUrls);
            if (!success)
            {
        ...
        public IActionResult Skill()
        {
            ...
            ViewBag.nav = HttpContext.Session.GetInt32("Nav");
            List<Skill> skills = _objIAdmin.skillls();
        ...
        {
            bool success = _objIAdmin.skillsave(skillView);
            if (!success)
            {
        ...
        {
            bool success = _objIAdmin.AddUser(email);
            return Json(new { success = success });
        }
        ...
        {
            bool success = _objIAdmin.deletemission(missionId);
            return Json(new { success = success });
            
           
        }
        [HttpPost]
        public IActionResult CheckSkill(long Skill,string Title)
        {
            bool success = _objIAdmin.SkillExists(Title,Skill);
            return Json(new { success = success });
        }

        [HttpPost]
        public IActionResult CheckTheme(long Theme, string Title)
        {
